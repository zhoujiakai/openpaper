...
| `open/ai-agent/agent-quiz.md` | ✅ 已生成（8 道题 + A4 默写记录） |
| `open/ai-agent/agent-mastery-report.md` | ✅ 已生成（掌握度 75%） |
| `open/ai-agent/agent-notes.md` | ⏳ 待写（个人笔记） |

## 回测计划

| 类型 | 计划日期 | 重点 |
|------|---------|------|
| 周测 | 2026-05-02 | 五种 Workflow + 选型框架 + Memory 三因素 |
