...
技术学习资源零散难追踪，学习过程缺少进度反馈与日志积累，难以衡量掌握程度与学习效率。

AI 工具的成熟让这些环节的成本被大幅压缩。

本仓库系统性收录 AI / CV / Web3 / 软件工程等领域的论文与教程，并配合阅读进度管理与 AI 精读工具，构建一个持续更新的知识库。既是个人学习笔记及日志，也是一份可复用的路径参考。
