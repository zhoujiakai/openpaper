...
- 机器学习
    - [processing/ml-吴恩达机器学习](processing/ml-吴恩达机器学习/)
        - 类型：网课，20小时，吴恩达经典的机器学习。
        - 学习时长：观看+消化+笔记 = 60小时。
        - 目标：掌握LSTM → [open/ml-lstm](open/ml-lstm/) 等模型的应用方法，能够开发一个机器学习系统，实现对设备的智能优化控制。

- PID算法
    - [open/ctrl-江协PID倒立摆](open/ctrl-江协PID倒立摆/)
